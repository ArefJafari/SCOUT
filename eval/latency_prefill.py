...
# Load model
config_path = "/work/marzieh/512x1k_15B_SWA_SCOUT_MLP_k10_0.34B_July4/final-model-ckpt.pth/pytorch_model.bin"
...
batch_sizes = [1,2] 
input_seq_lens =  [2048,4096,8192,16384,32768,65536]
max_new_tokens_list = [10]
vocab_size = 32000
# Prepare CSV
csv_filename = f"{model_name}"+"_triton"
            ...
            for max_new_tokens in max_new_tokens_list:
                ...
                try:
                    ...
                    if "out of memory" in str(e):
                        print(f" OOM occurred during warmup. Skipping this configuration.")
